...
public class CheckLineService {
    ...
    public CheckLineService(CheckLineRepository checkLineRepository, ProductRepository productRepository, CheckTableRepository checkTableRepository, ModelMapper modelMapperCheckline) {
